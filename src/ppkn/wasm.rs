...
enum Instr {
    ...
    Br { label: u32 },
    BrIf { label: u32 },
    BrTable { labels: Vec<u32> },
    Return,
    CallIndirect { table: u32, func_type: u32 },
    Drop,
    LocalGet,
    LocalSet,
    LocalTee,
    ...
    I32Load16S { offset: u32, align: u32 },
    I32Load16U { offset: u32, align: u32 },
    ...
    I32Store16 { offset: u32, align: u32 },
...
impl WebAssemblyModule {
    fn to_wasm(self) -> Vec<u8> {
        ...
        let imports: Vec<_> = self
            .imports
            .into_iter()
            .map(|import| import.to_wasm(&mut ctx))
            .collect();
        let functions: Vec<_> = self
            .funcs
            .into_iter()
            .map(|(_, func)| func.to_wasm(&mut ctx))
            .collect();
...
impl Func {
    fn to_wasm(&self, ctx: &mut CompilationContext) -> Vec<u8> {
        ...
        self.body
            .iter()
            .for_each(|instr| instr.to_wasm(ctx, &mut code));
        code.push(0x0B);
...
impl Instr {
    fn to_wat(&self, ctx: &WebAssemblyModule) -> String {
        ...
        match self {
            ...
            Instr::CallIndirect { table, func_type } => {
                format!("call_indirect {} {}", table, func_type)
            }
    ...
    fn to_wasm(&self, ctx: &mut CompilationContext, wasm: &mut Vec<u8>) {
        match self {
            ...
            Instr::I32Eqz => wasm.push(0x45),
            Instr::I32Eq => wasm.push(0x46),
            Instr::I32Ne => wasm.push(0x47),
            Instr::I32LtS => wasm.push(0x48),
            Instr::I32LtU => wasm.push(0x49),
            Instr::I32GtS => wasm.push(0x4A),
            Instr::I32GtU => wasm.push(0x4B),
            Instr::I32LeU => wasm.push(0x4C),
            Instr::I32LeS => wasm.push(0x4D),
            Instr::I32GeS => wasm.push(0x4E),
            Instr::I32GeU => wasm.push(0x4F),
            Instr::I64Eqz => wasm.push(0x50),
            Instr::I64Eq => wasm.push(0x51),
            Instr::I64Ne => wasm.push(0x52),
            Instr::I64LtS => wasm.push(0x53),
            Instr::I64LtU => wasm.push(0x54),
            Instr::I64GtS => wasm.push(0x55),
            Instr::I64GtU => wasm.push(0x56),
            Instr::I64LeU => wasm.push(0x57),
            Instr::I64LeS => wasm.push(0x58),
            Instr::I64GeS => wasm.push(0x59),
            Instr::I64GeU => wasm.push(0x5A),
            Instr::F32Eq => wasm.push(0x5B),
            Instr::F32Ne => wasm.push(0x5C),
            Instr::F32Lt => wasm.push(0x5D),
            Instr::F32Gt => wasm.push(0x5E),
            Instr::F32Le => wasm.push(0x5F),
            Instr::F32Ge => wasm.push(0x60),
            Instr::F64Eq => wasm.push(0x61),
            Instr::F64Ne => wasm.push(0x62),
            Instr::F64Lt => wasm.push(0x63),
            Instr::F64Gt => wasm.push(0x64),
            Instr::F64Le => wasm.push(0x65),
            Instr::F64Ge => wasm.push(0x66),
            Instr::I32Clz => wasm.push(0x67),
            Instr::I32Ctz => wasm.push(0x68),
            Instr::I32Popcnt => wasm.push(0x69),
            Instr::I32Add => wasm.push(0x6A),
            Instr::I32Sub => wasm.push(0x6B),
            Instr::I32Mul => wasm.push(0x6C),
            Instr::I32DivS => wasm.push(0x6D),
            Instr::I32DivU => wasm.push(0x6E),
            Instr::I32RemS => wasm.push(0x6F),
            Instr::I32RemU => wasm.push(0x70),
            Instr::I32And => wasm.push(0x71),
            Instr::I32Or => wasm.push(0x72),
            Instr::I32Xor => wasm.push(0x73),
            Instr::I32Shl => wasm.push(0x74),
            Instr::I32ShrS => wasm.push(0x75),
            Instr::I32ShrU => wasm.push(0x76),
            Instr::I32Rotl => wasm.push(0x77),
            Instr::I32Rotr => wasm.push(0x78),
            Instr::I64Clz => wasm.push(0x79),
            Instr::I64Ctz => wasm.push(0x7A),
            Instr::I64Popcnt => wasm.push(0x7B),
            Instr::I64Add => wasm.push(0x7C),
            Instr::I64Sub => wasm.push(0x7D),
            Instr::I64Mul => wasm.push(0x7E),
            Instr::I64DivS => wasm.push(0x7F),
            Instr::I64DivU => wasm.push(0x80),
            Instr::I64RemS => wasm.push(0x81),
            Instr::I64RemU => wasm.push(0x82),
            Instr::I64And => wasm.push(0x83),
            Instr::I64Or => wasm.push(0x84),
            Instr::I64Xor => wasm.push(0x85),
            Instr::I64Shl => wasm.push(0x86),
            Instr::I64ShrS => wasm.push(0x87),
            Instr::I64ShrU => wasm.push(0x88),
            Instr::I64Rotl => wasm.push(0x89),
            Instr::I64Rotr => wasm.push(0x8A),
            Instr::F32Abs => wasm.push(0x8B),
            Instr::F32Neg => wasm.push(0x8C),
            Instr::F32Ceil => wasm.push(0x8D),
            Instr::F32Floor => wasm.push(0x8E),
            Instr::F32Trunc => wasm.push(0x8F),
            Instr::F32Nearest => wasm.push(0x90),
            Instr::F32Sqrt => wasm.push(0x91),
            Instr::F32Add => wasm.push(0x92),
            Instr::F32Sub => wasm.push(0x93),
            Instr::F32Mul => wasm.push(0x94),
            Instr::F32Div => wasm.push(0x95),
            Instr::F32Min => wasm.push(0x96),
            Instr::F32Max => wasm.push(0x97),
            Instr::F32Copysign => wasm.push(0x98),
            Instr::F64Abs => wasm.push(0x99),
            Instr::F64Neg => wasm.push(0x9A),
            Instr::F64Ceil => wasm.push(0x9B),
            Instr::F64Floor => wasm.push(0x9C),
            Instr::F64Trunc => wasm.push(0x9D),
            Instr::F64Nearest => wasm.push(0x9E),
            Instr::F64Sqrt => wasm.push(0x9F),
            Instr::F64Add => wasm.push(0xA0),
            Instr::F64Sub => wasm.push(0xA1),
            Instr::F64Mul => wasm.push(0xA2),
            Instr::F64Div => wasm.push(0xA3),
            Instr::F64Min => wasm.push(0xA4),
            Instr::F64Max => wasm.push(0xA5),
            Instr::F64Copysign => wasm.push(0xA6),
            Instr::I32WrapI64 => wasm.push(0xA7),
            Instr::I32TruncF32S => wasm.push(0xA8),
            Instr::I32TruncF32U => wasm.push(0xA9),
            Instr::I32TruncF64S => wasm.push(0xAA),
            Instr::I32TruncF64U => wasm.push(0xAB),
            Instr::I64ExtendI32S => wasm.push(0xAC),
            Instr::I64ExtendI32U => wasm.push(0xAD),
            Instr::I64TruncF32S => wasm.push(0xAE),
            Instr::I64TruncF32U => wasm.push(0xAF),
            Instr::I64TruncF64S => wasm.push(0xB0),
            Instr::I64TruncF64U => wasm.push(0xB1),
            Instr::F32ConvertI32S => wasm.push(0xB2),
            Instr::F32ConvertI32U => wasm.push(0xB3),
            Instr::F32ConvertI64S => wasm.push(0xB4),
            Instr::F32ConvertI64U => wasm.push(0xB5),
            Instr::F32DemoteF64 => wasm.push(0xB6),
            Instr::F64ConvertI32S => wasm.push(0xB7),
            Instr::F64ConvertI32U => wasm.push(0xB8),
            Instr::F64ConvertI64S => wasm.push(0xB9),
            Instr::F64ConvertI64U => wasm.push(0xBA),
            Instr::F64PromoteF32 => wasm.push(0xBB),
            Instr::I32ReinterpretF32 => wasm.push(0xBC),
            Instr::I64ReinterpretF64 => wasm.push(0xBD),
            Instr::F32ReinterpretI32 => wasm.push(0xBE),
            Instr::F64ReinterpretI64 => wasm.push(0xBF),
            Instr::I32Extend8S => wasm.push(0xC0),
            Instr::I32Extend16S => wasm.push(0xC1),
            Instr::I64Extend8S => wasm.push(0xC2),
            Instr::I64Extend16S => wasm.push(0xC3),
