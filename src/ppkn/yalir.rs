...
pub mod instr {
	...
	pub const NAMES: [&str; 80] = [
		"unreachable", "pass", "block", "loop", "if_then", "else", "end",
		"jump", "jump_if", "jump_into", "return", "call_func", "call_import",
		"call_indirect", "drop", "select", "global.get", "global.set",
		"local.get", "local.set", "local.tee", "memory.size", "memory.grow",
		"f32.const", "f32.load", "f32.store", "f32.abs", "f32.ceil",
		"f32.floor", "f32.nearest", "f32.neg", "f32.sqrt", "f32.trunc",
		"f32.copysign", "f32.add", "f32.div", "f32.max", "f32.min", "f32.mul",
		"f32.sub", "f32.eq", "f32.ge", "f32.gt", "f32.le", "f32.lt", "f32.ne",
		"i32.const", "i32.load", "i32.store", "i32.and", "i32.or", "i32.xor",
		"i32.add", "i32.div", "i32.mul", "i32.rem", "i32.rotl", "i32.rotr",
		"i32.shl", "i32.shr", "i32.sub", "i32.eqz", "i32.eq", "i32.ge",
		"i32.gt", "i32.le", "i32.lt", "i32.ne", "u32.const", "u32.add",
		"u32.div", "u32.mul", "u32.rem", "u32.shl", "u32.shr", "u32.sub",
		"u32.ge", "u32.gt", "u32.le", "u32.lt",
	];
}
